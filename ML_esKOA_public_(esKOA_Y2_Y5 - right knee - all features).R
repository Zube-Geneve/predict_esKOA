...
if (outcomes == "knee_esKOA_new_y2_right") {
  pdf_file_xgb_orig <- "XXXXX/roc_curve_plot_xgb_orig_INT_TEST_OAI_y2.pdf"
} else if (outcomes == "knee_esKOA_new_y5_right") {
  pdf_file_xgb_orig <- "XXXXX/roc_curve_plot_xgb_orig_INT_TEST_OAI_y5.pdf"
}
...
# Determine the file path based on the outcome
if (outcomes == "knee_esKOA_new_y2_right") {
  pdf_file_xgb_orig_OAI_opt <- "XXXXX/roc_curve_plot_xgb_orig_INT_TEST_OAI_opt_y2.pdf"
} else if (outcomes == "knee_esKOA_new_y5_right") {
  pdf_file_xgb_orig_OAI_opt <- "XXXXX/roc_curve_plot_xgb_orig_INT_TEST_OAI_opt_y5.pdf"
}
...
# Determine the file path based on the outcome
if (outcomes == "knee_esKOA_new_y2_right") {
  pdf_file_xgb_orig_MOST <- "XXXXX/roc_curve_plot_xgb_orig_MOST_y2.pdf"
} else if (outcomes == "knee_esKOA_new_y5_right") {
  pdf_file_xgb_orig_MOST <- "XXXXX/roc_curve_plot_xgb_orig_MOST_y5.pdf"
}
...
# Determine the file path based on the outcome
if (outcomes == "knee_esKOA_new_y2_right") {
  pdf_file_xgb_orig_MOST_opt <- "XXXXX/roc_curve_plot_xgb_orig_MOST_opt_y2.pdf"
} else if (outcomes == "knee_esKOA_new_y5_right") {
  pdf_file_xgb_orig_MOST_opt <- "XXXXX/roc_curve_plot_xgb_orig_MOST_opt_y5.pdf"
}
